                ...
                <div class="product__image_loupe">
                    <div class="product__image_slider-main">
                        <div class="product__image_slider-big gallery-images">
                            <a href="<?php echo get_template_directory_uri(); ?>/assets/img/34.jpg" data-fancybox="gallery" data-title="TOYOTA Camry">
                                <div class="product__image_slider-big-slide"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/34.jpg" title="TOYOTA Camry" id="image-1" data-zoom-image="<?php echo get_template_directory_uri(); ?>/assets/img/34.jpg" /></div>
                            </a>
                            <a href="<?php echo get_template_directory_uri(); ?>/assets/img/35.jpg" data-fancybox="gallery" data-title="TOYOTA Camry">
                                <div class="product__image_slider-big-slide"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/35.jpg" title="TOYOTA Camry" id="image-2" data-zoom-image="<?php echo get_template_directory_uri(); ?>/assets/img/35.jpg" /></div>
                            </a>
                            ...
                            <a href="https://youtu.be/DSY--BB_APk" data-fancybox="gallery" data-title="TOYOTA Camry">
                                <div class="product__image_slider-big-slide product__image_slider-big-slide_video"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/33.jpg" title="TOYOTA Camry" alt="TOYOTA Camry" id="image-6" /></div>
                            </a>
                        </div>
                    </div>
